...
This section includes the following capture rules pertaining to BlockfaceID conflation from Pavement Edge to CSCL for these special/complex cases:<br>
1. Capture Rule for missing CSCL<br>
2. Capture Rule for Medians<br>
3. Capture Rule for Multiple CSCL with Single Pavement Edge<br>
...
• In cases where there are multiple CSCL segments running along a single Pavement Edge (median or otherwise), the BlockfaceID from the PavementEdge was conflated to the CSCL segments that correspond to the single Pavement Edge.<br>
